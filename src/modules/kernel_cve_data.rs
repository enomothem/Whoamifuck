// Auto-ported from who.sh dirty_cow VULNERABLE_VERSIONS list (CVE-2016-5195).
// Do not edit by hand; this mirrors the original bash data table.

pub const VULNERABLE_KERNELS: &[&str] = &[
